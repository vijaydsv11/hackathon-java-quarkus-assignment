 ...
 *
 * <p>
 * This class implements the {@link ReplaceWarehouseOperation} interface and
 * handles
 * all business logic for updating an existing warehouse's properties. It
 * validates:
 * <ul>
 ...
 *
 * <p>
 * All operations are transactional to ensure data consistency. The use case
 * applies
 * optimistic locking through the warehouse store to detect concurrent
 * modifications.
 *
 * <p>
...
public class ReplaceWarehouseUseCase implements ReplaceWarehouseOperation {
     ...
     *
     * @param warehouseStore   the warehouse store for persistence operations (must
     *                         not be null)
     * @param locationResolver the location resolver for validating locations (must
     *                         not be null)
     */
     ...
     *
     * <p>
     * Convenience method that delegates to the parameterized replace method,
     ...
     * @throws IllegalArgumentException if warehouse validation fails (see
     *                                  {@link #replace(String, String, int, int)})
     */
     ...
     *
     * <p>
     * Updates the location, capacity, and stock of an existing warehouse. Performs
     * comprehensive
     ...
     *
     * <p>
     * <strong>Optimistic Locking:</strong> May throw an exception if another
     * transaction
     * concurrently modified the warehouse (version mismatch).
     *
     * @param businessUnitCode the unique identifier of the warehouse to update
     *                         (must not be null or blank)
     * @param newLocation      the new warehouse location identifier (must be
     *                         resolvable by LocationResolver)
     * @param capacity         the new warehouse capacity (must be non-negative and
     *                         ≤ location max capacity)
     * @param stock            the new stock level (must be non-negative and ≤
     *                         capacity)
     * @throws IllegalArgumentException if any of the following validation checks
     *                                  fail:
     *                                  <ul>
     *                                  <li>Business unit code is null or blank</li>
     *                                  <li>Warehouse with the code does not
     *                                  exist</li>
     *                                  <li>Warehouse is archived</li>
     *                                  <li>Location is invalid or not
     *                                  resolvable</li>
     *                                  <li>Capacity is negative</li>
     *                                  <li>Stock is negative</li>
     *                                  <li>Capacity exceeds location maximum
     *                                  capacity</li>
    ...
    public void replace(String businessUnitCode,
        ...
        Location location = locationResolver.resolveByIdentifier(newLocation);
